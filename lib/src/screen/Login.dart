      ...
      body: Container(
        ...
        child: Center(
          child: SizedBox(
              ...
              children: <Widget>[
                Text('Welcome to RC-EXPEDITE', style: TextStyle(
                ...
                Text.rich(
                  TextSpan(
                    children: <TextSpan>[
                      TextSpan(text: 'enter your ', style: TextStyle(
                      ),),
                      ...
                      TextSpan(text: ' to start your session', style: TextStyle(
                      ),),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: <Widget>[
                      ...
                      InputFormContainer(title: 'PASSWORD', myController: password),
                      SizedBox(height: 10,),
                      Row(
                        children: <Widget>[
                          ...
                          Button(label: 'LOG IN', press: _login, icon: Icons.arrow_forward_ios)
                        ],
                      )
                  ],),),
                )
